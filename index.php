                ...
                <div class="row">
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="#services"><i class="fa-solid fa-kit-medical"></i> Services</button></a></li>
                            <li><a href="#about_us"><i class="fa-solid fa-address-card"></i> About Us</a></li>
                            <li><a href="#gallery"><i class="fa-brands fa-envira"></i> Gallery</a></li>
                            <li><a href="#contact_us"><i class="fa-solid fa-envelope"></i> Contact Us</a></li>
                            <li><a href="#logins"><i class="fa-solid fa-right-to-bracket"></i> Login</a></li>  
                        </ul>
                    </div>
                    <div class="col-sm-2 d-none d-lg-block appoint"><!-- ################# Book Appoinment#######################--->
                        <div class="wrapper">
                            <div class="icon appoinment">
                                <div class="tooltip">
                                    Book an Appointment
                                    </div>
                                        <span ><a href="hms/user-login.php"><i class="fa-solid fa-calendar-check"></i></a></span>
                                    </div>
                                </div>
